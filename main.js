...
const models = [
    "./3d materials/element_001_hydrogen.glb",
    "./3d materials/element_002_helium.glb",
    "./3d materials/element_003_lithium.glb",
    "./3d materials/element_004_beryllium.glb",
    "./3d materials/element_005_boron.glb",
    "./3d materials/element_006_carbon.glb",
    "./3d materials/element_007_nitrogen.glb",
    "./3d materials/element_008_oxygen.glb",
    "./3d materials/element_009_fluorine.glb",
    "./3d materials/element_010_neon.glb",
    "./3d materials/element_011_sodium.glb",
    "./3d materials/element_012_magnesium.glb",
    "./3d materials/element_013_aluminum.glb",
    "./3d materials/element_014_silicon.glb",
    "./3d materials/element_015_phosphorus.glb",
    "./3d materials/element_016_sulfur.glb",
    "./3d materials/element_017_chlorine.glb",
    "./3d materials/element_018_argon.glb",
];
...
function noteLayout(table, index) {
    ...
    //(table[3] * 140) - window.innerWidth; // - 1330
    object.position.y = 900;
    //-(table[4] * 160) + window.innerHeight; // + 990
    object.position.z = 0;
...
function tableLayout(table, index) {
    ...
    object.position.x = (table[index + 3] * 140) - window.innerWidth; // - 1330
    object.position.y = -(table[index + 4] * 160) + window.innerHeight; // + 990
    targets.table.push(object);
